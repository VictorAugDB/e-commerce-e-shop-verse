  ...
  return (
    <Dialog.Root open={isWritingReview} onOpenChange={setIsWritingReview}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] max-h-[85vh] w-[95vw] translate-x-[-50%] translate-y-[-45%] overflow-auto rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none data-[state=open]:animate-contentShow sm:w-[90vw]">
